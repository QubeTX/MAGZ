...
const brands = [
  { name: "Buffalo Wild Wings", url: "https://www.buffalowildwings.com/", logo: "/brandLogos/BWW-WHITE.svg", hoverLogo: "/brandLogos/BWW-COLOR.svg", fullColor: true, logoClass: "max-w-[65%] max-h-[55%]" },
  ...
  { name: "Q30 Innovations", url: "https://q30.com/", logo: "/brandLogos/q30.svg", logoClass: "w-[65%] max-h-[35%]" },
              ...
              {brand.textLogo ? (
                ...
                <>
                  <img
                    src={brand.logo}
                    alt={brand.name}
                    className={`${brand.logoClass || 'max-w-[80%] max-h-[70%]'} object-contain z-10 relative transition-opacity duration-300 opacity-100 group-hover:opacity-0`}
                  />
                  <img
                    src={brand.hoverLogo}
                    alt={brand.name}
                    className={`${brand.logoClass || 'max-w-[80%] max-h-[70%]'} object-contain z-10 absolute inset-0 m-auto transition-opacity duration-300 opacity-0 group-hover:opacity-100`}
                  />
                </>
              ) : (
                <img
